...
/*
    Integer[] vals = new Integer[]{-1, 7, 123, null, 50, 60, 100};
    return Stream.of(
        Arguments.of(ReductionOp.MAX, new Integer[0], Scalar.fromNull(TypeId.DATE32)),
        Arguments.of(ReductionOp.MAX, new Integer[]{null, null, null},
            Scalar.fromNull(TypeId.DATE32)),
...
/*
    Long[] vals = new Long[]{-1L, 7L, 123L, null, 50L, 60L, 100L};
    return Stream.of(
        Arguments.of(ReductionOp.MAX, new Long[0], Scalar.fromNull(TypeId.DATE64)),
        Arguments.of(ReductionOp.MAX, new Long[]{null, null, null}, Scalar.fromNull(TypeId.DATE64)),
